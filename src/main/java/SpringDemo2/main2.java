...
//        它是从磁盘路径上加载配置文件，配置文件可以在磁盘的任何位置。
        ...
        ApplicationContext appp = new FileSystemXmlApplicationContext("/Users/lixiaofeng/Library/Mobile Documents/com~apple~CloudDocs/Documents/myGItProject/myJava/src/main/resources/ApplicationContest.xml");
