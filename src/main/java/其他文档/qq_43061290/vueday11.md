...
添加到暂存求： git add . 提交到本地仓库： git commit -m ‘完成了分类参数开发’ 推送到码云： git push 切换到master ： git checkout master 合并到master ： git merge goods_params

创建子分支 git checkout -b goods_list 推送至码云 git push -u origin goods_list
...
```
# **文章地址： **https://blog.csdn.net/qq_43061290/article/details/112538534