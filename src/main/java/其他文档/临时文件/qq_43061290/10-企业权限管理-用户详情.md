...
<img src="https://img-blog.csdnimg.cn/20200419110956539.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQzMDYxMjkw,size_16,color_FFFFFF,t_70" alt="在这里插入图片描述"/>
...
<body class="hold-transition skin-purple sidebar-mini">
    ...
    <!-- @@block = content -->
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                - [<i class="fa fa-dashboard"></i> 首页](${pageContext.request.contextPath}/index.jsp)
                - [用户管理](${pageContext.request.contextPath}/user/findAll.do)
                - 用户详情
            </ol>
        </section>
        <!-- 内容头部 /-->
    ...
    <footer class="main-footer">
        ...
        **Copyright &amp;copy; 2014-2017 [研究院研发部](http://www.itcast.cn).** All rights reserved.
    </footer>
    <!-- 底部导航 /-->
...
```
# **文章地址： **https://blog.csdn.net/qq_43061290/article/details/105611895