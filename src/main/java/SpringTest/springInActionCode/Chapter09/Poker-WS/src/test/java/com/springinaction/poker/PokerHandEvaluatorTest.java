...
public class PokerHandEvaluatorTest extends TestCase {
  ...
  public void testFourOfAKind() {
    assertEquals(PokerHandType.FOUR_OF_A_KIND, 
        evaluator.evaluateHand(FOUR_OF_A_KIND));
    
    Assert.assertNotEquals(PokerHandType.FOUR_OF_A_KIND, 
        evaluator.evaluateHand(THREE_OF_A_KIND));

    Assert.assertNotEquals(PokerHandType.FOUR_OF_A_KIND, 
        evaluator.evaluateHand(FULL_HOUSE));

    Assert.assertNotEquals(PokerHandType.FOUR_OF_A_KIND, 
        evaluator.evaluateHand(TWO_PAIR));
  }
  
  public void testThreeOfAKind() {
    assertEquals(PokerHandType.THREE_OF_A_KIND, 
        evaluator.evaluateHand(THREE_OF_A_KIND));
    
    Assert.assertNotEquals(PokerHandType.THREE_OF_A_KIND, 
        evaluator.evaluateHand(FOUR_OF_A_KIND));
  ...
  public void testTwoPair() {
    assertEquals(PokerHandType.TWO_PAIR, 
        evaluator.evaluateHand(TWO_PAIR));
    
    Assert.assertNotEquals(PokerHandType.TWO_PAIR, 
        evaluator.evaluateHand(THREE_OF_A_KIND));
  ...
  public void testFlush() {
    assertEquals(PokerHandType.FLUSH, 
        evaluator.evaluateHand(FLUSH));
    
    Assert.assertNotEquals(PokerHandType.FLUSH, 
        evaluator.evaluateHand(THREE_OF_A_KIND));
  ...
  public void testRoyalFlush() {
    assertEquals(PokerHandType.ROYAL_FLUSH, 
        evaluator.evaluateHand(ROYAL_FLUSH));
    
    Assert.assertNotEquals(PokerHandType.ROYAL_FLUSH, 
        evaluator.evaluateHand(FLUSH));
  ...
  public void testStraightFlush() {
    assertEquals(PokerHandType.STRAIGHT_FLUSH, 
        evaluator.evaluateHand(STRAIGHT_FLUSH));
    
    Assert.assertNotEquals(PokerHandType.STRAIGHT_FLUSH, 
        evaluator.evaluateHand(FLUSH));
    ...
    Assert.assertNotEquals(PokerHandType.STRAIGHT_FLUSH,
        evaluator.evaluateHand(STRAIGHT));
  }
  
  public void testStraight() {
    assertEquals(PokerHandType.STRAIGHT, 
        evaluator.evaluateHand(STRAIGHT));
    
    Assert.assertNotEquals(PokerHandType.STRAIGHT, 
        evaluator.evaluateHand(STRAIGHT_FLUSH));
  ...
  public void testNone() {
    assertEquals(PokerHandType.NONE, 
        evaluator.evaluateHand(NONE));
    
    Assert.assertNotEquals(PokerHandType.NONE, 
        evaluator.evaluateHand(STRAIGHT_FLUSH));
