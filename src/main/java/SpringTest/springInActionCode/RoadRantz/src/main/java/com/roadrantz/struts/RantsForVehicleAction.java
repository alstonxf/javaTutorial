package SpringTest.springInActionCode.RoadRantz.src.main.java.com.roadrantz.struts;
...
public class RantsForVehicleAction extends ActionSupport {
  public ActionForward execute(ActionMapping mapping, ActionForm form, 
    ...
    RantService rantService =
      (RantService) getWebApplicationContext().getBean("rantService");
    
    request.setAttribute("rants",
        rantService.getRantsForVehicle(vehicleForm.getVehicle()));
